...
public class NullamDbContext : DbContext
{
    ...
    private static void PopulateEventParticipants(NullamDbContext context, SocialEvent[] events)
    {
        ...
        {
            int numberOfPersonParticipants = rnd.Next(1, 6); // Random number of person participants
            int numberOfCompanyParticipants = rnd.Next(1, 3); // Random number of company participants
